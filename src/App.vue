  ...
  <div id="app">
    <div id="topNavBox">
      ...
      <div class="btn">
        <ul>
          <router-link to="/home">
            <img src="@/assets/home.svg" title="图表" />
          </router-link>
          <router-link to="/showkey">
            <img src="@/assets/id.svg" title="显示所有id" />
          </router-link>
          <router-link to="/showname">
            <img src="@/assets/ren.svg" title="显示所有用户名" />
          </router-link>
          <router-link to="/searchmessega">
            <img
              src="@/assets/searchMessega.svg"
              title="通过用户名来查找消息"
            />
          </router-link>
          <router-link to="/searchuser">
            <img
              src="@/assets/searchUser.svg"
              title="通过消息来查找用户名"
              style="width: 60%"
            />
          </router-link>
...
.loading::after {
  ...
  width: 100%;
  height: 100%;
  background: #fff url("./assets/jiazai.gif") no-repeat center;
  border-radius: 25px;
}
body {
